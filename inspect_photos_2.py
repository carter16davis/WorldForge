...
def main(folder: str) -> None:
    ...
    if v.get("spun_in_place"):
        print("\n*** LOOKS LIKE YOU SPUN IN PLACE ***")
        print("    Many directions, but the camera never moved. That photographs")
        print("    several different scenes, not several sides of one building.")
        print("    Walk a loop AROUND the building instead.")
